      ...
      if (ptot < 100) {
        ...
        do {
          ...
          if (roll == 1) {
            ...
            if (turnTotal < 20 && (turnTotal + ctot < 100)) { //added (turnTotal + ctot < 100)
              System.out.println("\tComputer will roll again.");
            }
          }
        } while (roll != 1 && turnTotal < 20 && (turnTotal + ctot < 100)); //added (turnTotal + ctot < 100)
...
/* Study Drills
1. In the example output given, the computer’s last roll was risky. The computer
only needed to get 15 points in the round to win the game, and the computer
already had earned 17 points in the round. So that last roll wasn’t necessary,
and the computer might have rolled a 1 and lost everything.
