...
/* Study Drill
1. Add a comment at the end of the Java file that has some words in it, and
make some of them begin with a capital letter. Then re-compile and re-run the
program to confirm that they get counted.
