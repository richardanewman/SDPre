...
/* Study Drill
1. Add a sixth dice. Notice how easy it is to display r6 by just
adding a single function call. (Don’t forget to also add the sixth
dice to the Boolean expression involving allSame.)
*/
