...
public class DictionaryOrder {
  public static void main(String[] args) {
    ...
    if (name.compareTo("lisp") == 0)
      System.out.println(name + " lispisn't a made-up language!");
    if (name.compareTo("lisp") > 0)
...
/* Study Drills
1. Using the technique of your choice, make this program work correctly
even if the human types in words with different capitalization.

A: see line 9 added .toLowerCase()
