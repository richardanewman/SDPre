...
/* Study Drills
1. Add extra code at the bottom to make the computer pick three random
integers from 1 to 3 and print them out on the screen.

2. Add code to pick three random integers from 5 to 10 and display them.
Run the program a bunch of times to confirm your numbers always stay in
that range.
